...
if __name__ == '__main__':
    out_path = 'results/csv/scalability/shape'
    os.makedirs(out_path, exist_ok=True)

    dataset, label = 'enron', 16
    for size in ['8-path', '8-tree', '12', '8-cycle', '8-dense']:
        ...
        np.savetxt(f'{out_path}/{dataset}_{size}_overall.csv', time_array, fmt='%12.1f', delimiter=',')
