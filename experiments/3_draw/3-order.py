...
if __name__ == '__main__':
    ...
    time_dblp = np.loadtxt(f'{input_path}/dblp_16_order.csv', delimiter=',')
    time_enron = np.loadtxt(f'{input_path}/enron_16_order.csv', delimiter=',')
    time_github = np.loadtxt(f'{input_path}/github_16_order.csv', delimiter=',')
    time_gowalla = np.loadtxt(f'{input_path}/gowalla_16_order.csv', delimiter=',')
    time_patents = np.loadtxt(f'{input_path}/patents_16_order.csv', delimiter=',')
    time_wikitalk = np.loadtxt(f'{input_path}/wikitalk_64_order.csv', delimiter=',')
