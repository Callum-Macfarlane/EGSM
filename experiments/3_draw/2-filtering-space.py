...
if __name__ == '__main__':
    ...
    time_dblp = np.loadtxt(f'{input_path}/filtering/dblp_16_filtering_space.csv', delimiter=',')
    time_enron = np.loadtxt(f'{input_path}/filtering/enron_16_filtering_space.csv', delimiter=',')
    time_github = np.loadtxt(f'{input_path}/filtering/github_16_filtering_space.csv', delimiter=',')
    time_gowalla = np.loadtxt(f'{input_path}/filtering/gowalla_16_filtering_space.csv', delimiter=',')
    time_patents = np.loadtxt(f'{input_path}/filtering/patents_16_filtering_space.csv', delimiter=',')
    time_wikitalk = np.loadtxt(f'{input_path}/filtering/wikitalk_64_filtering_space.csv', delimiter=',')
