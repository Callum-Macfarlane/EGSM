...
if __name__ == '__main__':
    ...
    axs.bar(np.arange(5) - 0.16, [100,100,42,21,6], width=0.32, hatch='-', color='none', edgecolor=color[3], label='CuTS')
    axs.bar(np.arange(5) + 0.16, [100,100,100,95,71], width=0.32, hatch='/', color='none', edgecolor=color[6], label='EGSM')
    #axs.set_yscale('log')
    ...
    fig.savefig(f'{result_path}/8-solved.pdf')
    plt.close()
